 ...
 */
class BsContasPagarFilter extends AbstractFilter
{
    ...
    public function __construct($serviceLocator = null)
    {
       ...
       // $repete->getValidatorChain()->attach($this->emptyfilter);
        ...
        $plano_conta_id->setRequired ( false);
        ...
        // Informação para a coluna fornecedor_id:
        $fornecedor_id = new Input ( "fornecedor_id" );
        $fornecedor_id->setRequired ( false);
        $fornecedor_id->getFilterChain ()->attach ( $this->StringTrim );
        $fornecedor_id->getFilterChain ()->attach ( $this->StripTags );
        //$fornecedor_id->getValidatorChain()->attach($this->emptyfilter);
        $this->add ( $fornecedor_id );
        ...
        // Informação para a coluna tipo_custo:
        $tipo_custo = new Input ( "tipo_custo" );
        $tipo_custo->setRequired ( false);
        $tipo_custo->getFilterChain ()->attach ( $this->StringTrim );
        $tipo_custo->getFilterChain ()->attach ( $this->StripTags );
        //$tipo_custo->getValidatorChain()->attach($this->emptyfilter);
        $this->add ( $tipo_custo );

        // Informação para a coluna apropriacao_custo:
        $apropriacao_custo = new Input ( "apropriacao_custo" );
        $apropriacao_custo->setRequired ( false);
        $apropriacao_custo->getFilterChain ()->attach ( $this->StringTrim );
        $apropriacao_custo->getFilterChain ()->attach ( $this->StripTags );
        //$apropriacao_custo->getValidatorChain()->attach($this->emptyfilter);
        $this->add ( $apropriacao_custo );
