 ...
 * BsUsers
 */
class Profile extends \Base\Model\AbstractModel {
    ...
    public function setPassword($password) {
        $this->password = base64_encode(\Zend\Crypt\Key\Derivation\Pbkdf2::calc('sha256', $password, $this->getEmail(), 10000, strlen('aFGQ475SDsdfsaf2342' * 2)));
        return $this;
    }
